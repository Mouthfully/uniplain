...
/**
 * The markdown twin of `/connectors/ga4`, per the llms.txt convention: same URL, extension replaced.
 *
...
export function GET(): Response {
  const page = AGENT_PAGES.find((p) => p.path === "/connectors/ga4");
  if (page === undefined) {
    ...
    return new Response("registry has no entry for /connectors/ga4", { status: 500 });
  }

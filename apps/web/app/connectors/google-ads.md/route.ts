...
/**
 * The markdown twin of `/connectors/google-ads`, per the llms.txt convention: same URL, extension replaced.
 *
...
export function GET(): Response {
  const page = AGENT_PAGES.find((p) => p.path === "/connectors/google-ads");
  if (page === undefined) {
    ...
    return new Response("registry has no entry for /connectors/google-ads", { status: 500 });
  }

...
/**
 * The markdown twin of `/connectors/meta-ads`, per the llms.txt convention: same URL, extension replaced.
 *
...
export function GET(): Response {
  const page = AGENT_PAGES.find((p) => p.path === "/connectors/meta-ads");
  if (page === undefined) {
    ...
    return new Response("registry has no entry for /connectors/meta-ads", { status: 500 });
  }

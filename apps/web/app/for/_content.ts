...
const DRAFTS: readonly SegmentDraft[] = [
   ...
   */
  {
    ...
    lead: "The till already knows what every day took. What it does not do is compare this week with last, work out what the average ticket did, put the advertising beside it, and tell you which of those is worth your morning.",
    reads: [
      {
        source: "loyverse",
        what: "Every receipt, as the till rang it: what the day took and how many receipts it took it over. A voided or refunded receipt reopens the day it belonged to, so no day is ever marked final.",
      },
      {
        source: "meta_ads",
        what: "What the advertising account spent, day by day, in the same currency as the till and on the same calendar.",
      },
    ],
    briefLead:
   ...
   */
  {
    ...
    lead: "Your store reports what an order was worth. The gateway takes its cut somewhere else, and the difference is the number you actually live on. This reads both from your own store and keeps them apart.",
    reads: [
      {
        source: "woocommerce",
      ...
      {
        source: "google_ads",
        what: "What the advertising account spent, day by day, on the same calendar as the orders.",
      },
    ],
    briefLead:
   ...
   */
  {
    ...
    lead: "Takings, the price of an average visit, and how many people reached the site that week. Separate accounts, read on your own logins, with nothing joined up that the data cannot actually join.",
    reads: [
      {
        source: "loyverse",
      ...
      {
        source: "google_ads",
        what: "What the advertising account spent, day by day, in the same currency as the till.",
      },
      {
        source: "ga4",
...
export const FOR_CLAIMS = {
  ...
  readOnly: claim("read-only-oauth"),
